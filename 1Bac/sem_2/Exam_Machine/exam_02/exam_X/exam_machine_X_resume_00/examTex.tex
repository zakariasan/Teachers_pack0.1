...
\hline
    ...
    $1.$ &
         \makecell{
             un schéma légendé du dispositif de titrage
 }
    & $1pt$\\\hline
 %Q2
     $2.$ &
         \makecell{l’équation de la réaction de dosage.\\
             $\ce{5Fe^{2+} + MnO^-_4 +8H^+ -> 5Fe^{3+} + Mn^{2+} + 4H_2O}$
         }
    & $1pt$\\\hline  
 %Q3-a
         $3.$ &
...
tableau d’avancement :\\
    ...
    \hline
                 \multicolumn{2}{|l|}{Equation de la réaction}& \multicolumn{4}{l|}{$\ce{5Fe^{2+} + MnO^-_4 +8H^+ -> 5Fe^{3+} + Mn^{2+} + 4H_2O}$
                 }\\\hline
    états  & avanc& \multicolumn{4}{|c|}{quantité de Matière en mol}\\\hline
                 Etat initial &0&$C_1V_1$ &$C_2V_2$ &0&  0 \\\hline
                 \makecell{Etat de \\transformation}&$x$ & $C_1V_1-5x$  & $C_2V_2-x$ & $ 5x$  & $x$ \\\hline
                 Etat final            &    $x_{max}$&  $C_1V_1-5x_{max}$& $C_2V_2-x_{max}$  & $5x_{m}$  & $x_{max}$ \\\hline
   % \cline{2-4}\
\end{tabular}
         }
    & $1pt$\\\hline  
 $4.$ &
         \makecell{
             la relation d’équivalence : $\frac{C_1.V_1}{5} = C_2.V_2$
 }
    & $1pt$\\\hline  
 %Q3-b
 $5.$ &
         \makecell{
 la concentration C1 de la solution (S1) : $C_1 = 0.22mol/L$
         }
    & $1.5pt$\\\hline  
 $6.a$ &
         \makecell{
             Quel est le réactif limitant : $Fe^{2+}$
         }
    & $1.5pt$\\\hline  
