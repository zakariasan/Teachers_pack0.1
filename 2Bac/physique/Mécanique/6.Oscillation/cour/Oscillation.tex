...
\begin{wrapfigure}{r}{0.3\textwidth}
	\vspace{-2cm}
	\includegraphics[width=0.3\textwidth]{./torsion02.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\vspace{-2cm}
	\includegraphics[width=0.3\textwidth]{./torsion01.png}
	\includegraphics[width=0.3\textwidth]{./torsion00.png}
\end{wrapfigure}
...
\begin{center}
	\includegraphics[width=0.7\textwidth]{./excitatio.png}
\end{center}
...
\begin{center}
	...
	\includegraphics[width=0.5\textwidth]{./excitation.png}
\end{center}
